...
public class TaskColumnService {
    ...
    public TaskColumn getTaskColumnByName (String name) {
        return taskColumnRepo.findByColumnName(name)
                .orElseThrow(() -> new ObjectNotFoundException("Task column with name: " + name + " doesn't exist!"));
    }
    ...
    public List<Card> getAllCards(Long id) {
        TaskColumn taskColumn = taskColumnRepo.findById(id)
                .orElseThrow(() -> new ObjectNotFoundException("Task column with id: " + id.toString() + " not found"));
    ...
    public TaskColumn addTaskColumnToBoard(Long taskColumnId, Long boardId) {
        ...
        Board board = boardRepo.findById(boardId)
                .orElseThrow(() -> new ObjectNotFoundException("Board with Id: " + boardId.toString() + " doesn't exist!"));
